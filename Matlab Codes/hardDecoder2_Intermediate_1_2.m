function estimatedMessage = hardDecoder2_Intermediate_1_2(receivedCode)   % decoder - temporary name
    ...
    while i<l
        ...
        while k <= 8
           temp(j) = pathMetric(8*s+k) + hammingDistance(twoBits,pairityGenerator_Intermediate_1_2(k-1,0),flag) + flag;
           temp(j+1) = pathMetric(8*s+k) + hammingDistance(twoBits,pairityGenerator_Intermediate_1_2(k-1,1),flag) + flag;
           j=j+2;
           k=k+1;
        end
